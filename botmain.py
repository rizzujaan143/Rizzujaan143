...
TELEGRAM_TOKEN = "8996315833:AAES7sY7GcxpdBlXqS182pJ_AgJ-iFVHO9o"
OWNER_ID = 7969092612

# 5 ғᴏʀᴄᴇ ᴊᴏɪɴ ᴄʜᴀɴɴᴇʟs
FORCE_JOIN_CHANNELS = [
    {"name": "MAIN CHANNEL", "id": "@rijwanbagwan786", "url": "https://t.me/rijwanbagwan786"},
...
# ✅ FIXED: Replaced deprecated get_event_loop()
...
╔══════════ 📊 𝐑𝐈𝐙𝐙𝐔 𝐒𝐘𝐒𝐓𝐄𝐌 𝐈𝐍𝐅𝐎 ═══════╗
┃
┣ 🤖 ʙᴏᴛ ɪᴅ      : 𝐑𝐈𝐙𝐙𝐔 𝐕𝐈𝐏 𝐁𝐀𝐍 𝐔𝐍𝐁𝐀𝐍 𝐁𝐎𝐓
┣ 👑 ᴏᴡɴᴇʀ ɪᴅ    : {OWNER_ID}
┣ ⏱ ᴜᴘᴛɪᴍᴇ       : {uptime}
...
┃
╚═════════════════════════════╝
╔══════ 🛠️ 𝐑𝐈𝐙𝐙𝐔 𝐓𝐎𝐎𝐋𝐒 𝐇𝐄𝐂𝐊𝐈𝐍𝐆 ════════╗
┃
┣ 🆔 /id              ➜ ɢᴇᴛ ᴜsᴇʀ ɪᴅ
┣ 🔐 /encode <text>   ➜ ʙᴀsᴇ64 ᴇɴᴄᴏᴅᴇ
┣ 🔓 /decode <base64> ➜ ʙᴀsᴇ64 ᴅᴇᴄᴏᴅᴇ
┣ #️⃣ /hash <text>     ➜ ɢᴇɴᴇʀᴀᴛᴇ ʜᴀsʜ
┣ 🌐 /ip <ip>         ➜ ɪᴘ ʟᴏᴏᴋᴜᴘ
┣ 🔑 /passgen [len]   ➜ ᴘᴀssᴡᴏʀᴅ ɢᴇɴ
┣ 👤 /userinfo        ➜ ᴜsᴇʀ ᴅᴇᴛᴀɪʟs
┣ 👥 /groupinfo       ➜ ɢʀᴏᴜᴘ ᴅᴇᴛᴀɪʟs
┣ 🔗 /short <url>     ➜ ᴜʀʟ sʜᴏʀᴛᴇɴᴇʀ
┃
╚═════════════════════════════╝
...
ℹ️ ғᴏʀᴍᴀᴛ: +92xxxxxxxxx
    ...
    keyboard = [
        [
            InlineKeyboardButton("💬 ᴄʜᴀᴛ ᴏᴡɴᴇʀ", url="https://t.me/SYEDHACKEROFFICIAL"),
            InlineKeyboardButton("📢 ᴄʜᴀɴɴᴇʟ", url="https://t.me/syedmethods")
        ],
        [InlineKeyboardButton("👥 ᴠɪᴘ ɢʀᴏᴜᴘ", url="https://t.me/syedtechteam")]
    ]
    reply_markup = InlineKeyboardMarkup(keyboard)
...
async def contact_command(update: Update, context: CallbackContext):
    keyboard = [
        [InlineKeyboardButton("💬 ᴅᴍ ᴏᴡɴᴇʀ", url="https://t.me/SYEDHACKEROFFICIAL")],
        [InlineKeyboardButton("📢 ᴊᴏɪɴ ᴄʜᴀɴɴᴇʟ", url="https://t.me/syedmethods")],
        [InlineKeyboardButton("👥 ᴊᴏɪɴ ɢʀᴏᴜᴘ", url="https://syedbanunbangroup")]
    ]
    reply_markup = InlineKeyboardMarkup(keyboard)
...
def main():
    ...
    print("🔒 𝐁𝐞𝐧𝐧 𝐛𝐨𝐭 @Rizzu_whatsapp_benn_143_bot")
